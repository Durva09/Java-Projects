    ...
    <body class="loading" data-layout-config='{"leftSideBarTheme":"dark","layoutBoxed":false, "leftSidebarCondensed":false, "leftSidebarScrollable":false,"darkMode":false, "showRightSidebarOnStart": true}'>
        <!-- Begin page -->
         <%
          ...
          ArrayList<VehicleDTO> arraylist=vehicle.getVehicleList(userid);
          %>
        <div class="wrapper">
            <!-- ========== Left Sidebar Start ========== -->
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row mb-2">
                                            <div class="col-sm-5">
                                                <a href="javascript:void(0);" class="btn btn-danger mb-2"><i class="mdi mdi-plus-circle me-2"></i> Add Vehical</a>
                                            </div>
                                            <div class="col-sm-7">
                                            ...
                                            <table class="table table-centered w-100 nowrap overflow-auto" id="products-datatable">
                                                ...
                                                <tbody>
                                                    <%int i=0;
                                                      ...
                                                      while(i<size)
                                                      {
                                                          VehicleDTO vehicle1=arraylist.get(i);
                                                    %>
                                                    <tr>
                                                        ...
                                                        <td>
                                                           <% String type= (String)vehicle1.getVehicletype();
                                                               switch(type){
                                                                   case "2":%><img src="assets/images/bike.png" alt="contact-img" title="contact-img" class="rounded me-3" height="48" /><%break;
                                                                   case "3":%><img src="assets/images/auto.png" alt="contact-img" title="contact-img" class="rounded me-3" height="48" /><%break;
                                                                   case "4":%><img src="assets/images/car.png" alt="contact-img" title="contact-img" class="rounded me-3" height="48" /><%break;
                                                                   case "6":%><img src="assets/images/bus.svg" alt="contact-img" title="contact-img" class="rounded me-3" height="48" /><%break;
                                                                   case "8":%><img src="assets/images/truck.svg" alt="contact-img" title="contact-img" class="rounded me-3" height="48" /><%break;
                                                               }
                                                           %>
                                                             <p class="m-0 d-inline-block align-middle font-16">
                                                                <a href="apps-ecommerce-products-details.html" class="text-body"><%=vehicle1.getName()%></a>
                                                                <br/>
                                                        ...
                                                        <td>
                                                            <%=vehicle1.getVehicletype()%> wheeler
                                                        </td>
                                                        <td>
                                                            <%=vehicle1.getPurchaseDate()%>
                                                        </td>
                                                        ...
                                                        <td class="table-action">
                                                            <center><a href="vehicleDetails.jsp?chassisno=<%=vehicle1.getChassis()%>"> <i class="mdi mdi-eye mdi-24px "></i></a></center>
                                                        </td>
                                                    </tr>
                                                    <% i++; }%>
                                                </tbody>
